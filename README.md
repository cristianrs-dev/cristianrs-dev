...
Sou desenvolvedor full stack com foco em back-end utilizando Java e Spring Boot, criando APIs RESTful com arquitetura organizada, código limpo e boas práticas de desenvolvimento.

Tenho experiência com desenvolvimento de sistemas, suporte técnico e ambientes reais de operação, o que me permite enxergar software além do código — compreendendo processos, infraestrutura e problemas do usuário final.

Atualmente estudo arquitetura de software, testes automatizados, segurança, CI/CD e engenharia de software, buscando evoluir como engenheiro de software, educador e empreendedor na área de tecnologia.
...
- Anotações e laboratórios sobre SQL, Node.js, Docker, APIs e arquitetura.
...
![Banco Relacional](https://img.shields.io/badge/Relational_Database-336791?style=flat)
![Modelagem de Dados](https://img.shields.io/badge/Data_Modeling-00599C?style=flat)
<br>
## 🧪 Testes e APIs
...
![REST API](https://img.shields.io/badge/REST_API-005571?style=flat)
![Spring Boot Test](https://img.shields.io/badge/Spring_Boot_Test-6DB33F?style=flat&logo=spring&logoColor=white)
![TDD](https://img.shields.io/badge/TDD-Test_Driven_Development-blue?style=flat)
<br>
## 🧠 Arquitetura e Boas Práticas
![MVC](https://img.shields.io/badge/MVC-Architecture-blue?style=flat)
![Clean Code](https://img.shields.io/badge/Clean_Code-000000?style=flat)
![SOLID](https://img.shields.io/badge/SOLID-Principles-orange?style=flat)
![3 Layers](https://img.shields.io/badge/3_Layers-Architecture-success?style=flat)
<br>
## 🧰 Ferramentas
